...
class ZurichRAW2RGB(torch.utils.data.Dataset):
    ...
    def _get_image_list(self, split):
        if split == 'train':
            image_list = ['{:d}.jpg'.format(i) for i in range(46239)] #46239
        elif split == 'val':
            image_list = ['{:d}.jpg'.format(i) for i in range(46239, 46539)] #46239, 46539 测试46539, 46839
        elif split == 'test':
            image_list = ['{:d}.jpg'.format(i) for i in range(46539, 46839)] #46239, 46539 测试46539, 46839
        else:
            raise Exception
