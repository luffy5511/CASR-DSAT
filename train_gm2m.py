...
def train(local_rank, world_size, args):
    ...
    deepSuperresolve_gm2m.MEAlign.load_state_dict(new_state_dict)
    ...
    for epoch in range(num_epochs):
        ...
        deepSuperresolve_m2i_path = os.path.join("/M2I/", 'checkpoint_{}.pth.tar'.format(epoch))
        ...
        for i, data in enumerate(train_loader):
            ...
            SR_ds_m2m = BackWarping(SR_m2m.unsqueeze(1).repeat(1, num_im, 1, 1, 1).view(-1, 1, sr_ratio * h, sr_ratio * w),
                                    local_rank,
            ...
            superviseloss = criterion(binary_noise_sr[..., 3:-3, 3:-3]*SR_m2m[..., 3:-3, 3:-3], binary_noise_sr[..., 3:-3, 3:-3]*SR_m2i.detach()[..., 3:-3, 3:-3])
