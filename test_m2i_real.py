...
def test(args):
    ...
    checkpoint_path = "/home/WXS/CYT/TrainHistory/single_loss_real（锐化）/checkpoint_24.pth.tar"
    ...
    Dataset_path = "/home/WXS/CYT/DBSR/test_real_burst/补充/爱特蒙特/"  # Make sure to preprocess the downloaded data first
    ...
    result_dir_SR ="/home/WXS/CYT/CASR/消融实验/single_loss/test_real_SR（锐化）/补充/爱特蒙特/"
    ##################
    starttime = time()
    ##################
    with torch.no_grad():
